        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input type="text" id="model_number" name="model_number" placeholder="e.g. 32S25NP" className="w-full bg-[#f9f9f9] border border-gray-300 py-2.5 px-4 font-inter text-sm text-black rounded focus:outline-none focus:border-black focus:ring-1 focus:ring-black transition-colors" />
            </div>
            <div>
              <label htmlFor="sku" className="block font-inter text-sm font-medium text-black mb-2">SKU</label>
              <input type="text" id="sku" name="sku" placeholder="e.g. THTV32S25NP" className="w-full bg-[#f9f9f9] border border-gray-300 py-2.5 px-4 font-inter text-sm text-black rounded focus:outline-none focus:border-black focus:ring-1 focus:ring-black transition-colors" />
            </div>
            <div>
              <label htmlFor="warranty" className="block font-inter text-sm font-medium text-black mb-2">Warranty Info</label>
              <input type="text" id="warranty" name="warranty" defaultValue="24 Month(s)" placeholder="e.g. 24 Month(s)" className="w-full bg-[#f9f9f9] border border-gray-300 py-2.5 px-4 font-inter text-sm text-black rounded focus:outline-none focus:border-black focus:ring-1 focus:ring-black transition-colors" />
            </div>
            <div>
              <label htmlFor="delivery_info" className="block font-inter text-sm font-medium text-black mb-2">Standard Delivery</label>
              <input type="text" id="delivery_info" name="delivery_info" defaultValue="3 - 5 Working Days" placeholder="e.g. 3 - 5 Working Days" className="w-full bg-[#f9f9f9] border border-gray-300 py-2.5 px-4 font-inter text-sm text-black rounded focus:outline-none focus:border-black focus:ring-1 focus:ring-black transition-colors" />
            </div>
            <div>
              <label htmlFor="pickup_info" className="block font-inter text-sm font-medium text-black mb-2">Pickup In-Store</label>
              <input type="text" id="pickup_info" name="pickup_info" defaultValue="Today Available" placeholder="e.g. Today Available" className="w-full bg-[#f9f9f9] border border-gray-300 py-2.5 px-4 font-inter text-sm text-black rounded focus:outline-none focus:border-black focus:ring-1 focus:ring-black transition-colors" />
            </div>
